...
def main():
    ...
    parser.add_argument('--model-file', type=str, default='/root/BEAL/logs/20220501_141138.213298/checkpoint_31.pth.tar',
                        help='Model path')
    parser.add_argument(
    ...
    test_loader = DataLoader(db_test, batch_size=8, shuffle=False, num_workers=1)
